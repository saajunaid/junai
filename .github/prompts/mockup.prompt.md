...
3. If an Intent Document exists in `.github/agent-docs/intents/`, read it first to understand the goal
...
3. Save to `.github/agent-docs/ux/mockups/<feature-name>-mockup.<ext>`
4. Update `.github/agent-docs/ARTIFACTS.md` with the new artifact
